...
```
###
### ***Function: 'spatial_spot_true_prop'***  
...
```
###
### ***Function: 'generate_plots_and_save'***  
...
```
##
## **2. Generate Gradient Arrays**  
### ***Function: 'get_gradation_2d'***  
...
```
### ***2.Generate Spatial Spot True Proportions:***  
...
```
### ***3.Generate Spatial Spot Locations:***  
...
#
# **Function: 'generate_type4_data'**    
## ***Description***    
The generate_type3_data function simulates spatial transcriptomics data for selected clusters with a distinct gradation pattern compared to other types. This function is designed to capture complex spatial relationships in gene expression data.   
#
# **Using Custom scRNA-seq and STARmap Data to Generate Simulated SRT Data**  
...
## ***Prerequisites:***  
  ...
  * The SSTD package, which contains necessary functions and example data.  
  * Custom scRNA-seq data in a tabular format with gene expression counts.  
  * Spatial location data for the spots in a tabular format with spatial coordinates.  
  * Cell type annotation for each spot in a tabular format.  
##
## ***Installation***  
### ***1.Install the SSTD package if you haven't already:***  
```r
install.packages("BiocManager")  
BiocManager::install("SSTD")  
```
### ***2.Load the SSTD package:***  
```r
library(SSTD)  
```
##
...
##
## ***Usage***  
### ***1.Define the paths to your data files:***   
```r
...
```
### ***2.Set the grid interval for spatial analysis and a prefix for the output files:***  
```r
grid_interval <- 500  # Adjust based on your spatial resolution  
prefix <- "my_simulation"  # Prefix for the output files  
```
### ***3.Call the Generating_simulation_data function with your data and parameters:***  
```r
...
```
### ***4.The function will generate several output files with the specified prefix, including simulated gene expression data, spatial locations, cell type proportions, and more.***  
##  
## ***Output Files***  
